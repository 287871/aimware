...
local avatarsdata = file.Open("picture/1.jpg", "r")
local avatars = avatarsdata:Read()
avatarsdata:Close()
...
local function Text()
    ...
    if lp ~= nil then
        ...
        draw.Color(Avatars_Circle_Clr:GetValue())
        draw.TextShadow(x + 65, y + 5, "Money ● ")

        draw.Color(Avatars_Circle_Clr2:GetValue())
