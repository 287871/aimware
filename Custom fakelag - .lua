...
local custom_fakelag_maxticks_Reference = gui.Reference("Misc", "General", "Server", "sv_maxusrcmdprocessticks")
local custom_fakelag_maxticks = custom_fakelag_maxticks_Reference:GetValue() + 1
    ...
    if lp ~= nil then
        ...
        if custom_fakelag_enabled:GetValue() then
            ...
            if miscM and gui.GetValue("rbot.master") and custom_fakelag_indicator:GetValue() then
                ...
                local maxticks = custom_fakelag_maxticks_Reference:GetValue()
